...
function GameWarning({ setShowWarning }: IProps) {
  ...
  return (
    <div className="w-full h-screen fixed top-0 left-0 flex items-center justify-center z-[60]">
      <div className="w-full h-full flex justify-center items-center backdrop-blur-sm backdrop-brightness-50">
        <div
          className="w-4/5 bg-white dark:bg-neutral-800 grid
            grid-cols-2 place-items-center gap-2 p-5 rounded-lg
            md:w-2/5
            lg:w-1/3
            2xl:w-1/5
            3xl:w-1/6
